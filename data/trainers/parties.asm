...
Rival1Data:
	...
	db 5, CLEFAIRY, 0
; Route 22
	db $FF, 9, PIDGEY, 8, SEEL, 0
	db $FF, 9, PIDGEY, 8, DODUO, 0
	db $FF, 9, PIDGEY, 8, CLEFAIRY, 0
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, SEEL, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, DODUO, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, CLEFAIRY, 0

ProfOakData:
; Unused
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, DEWGONG, 70, GYARADOS, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, DODRIO, 70, GYARADOS, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, CLEFABLE, 70, GYARADOS, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, SEEL, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, DODUO, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, CLEFAIRY, 0
; Pokémon Tower 2F
	db $FF, 25, PIDGEOTTO, 23, GROWLITHE, 22, EXEGGCUTE, 20, KADABRA, 25, SEEL, 0
	db $FF, 25, PIDGEOTTO, 23, GYARADOS, 22, GROWLITHE, 20, KADABRA, 25, DODUO, 0
	db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, GYARADOS, 20, KADABRA, 25, CLEFAIRY, 0
; Silph Co. 7F
	db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, ALAKAZAM, 40, DEWGONG, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, ALAKAZAM, 40, DODRIO, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, ALAKAZAM, 40, CLEFABLE, 0
; Route 22
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GROWLITHE, 47, EXEGGCUTE, 50, ALAKAZAM, 53, DEWGONG, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GYARADOS, 47, GROWLITHE, 50, ALAKAZAM, 53, DODRIO, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, CLEFABLE, 0

Rival3Data:
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, DEWGONG, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, DODRIO, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, CLEFABLE, 0
