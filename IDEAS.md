# PokeRiver Romhack - Ideas & Notes

A scratchpad for brainstorming changes, themes, and design goals.
...
| Gym | Original Leader | Original Type | Notes |
|-----|----------------|---------------|-------|
| Pewter | Brock | Rock | |
...
## Wild Encounter Ideas

_Notes on how wild encounters should differ from vanilla:_

- Early routes: more variety? Different starters in the wild?
- Safari Zone: rare Pokemon availability?
- Legendaries: keep locations or move them?
...
_Possible engine-level improvements (these require more involved ASM work):_

- Reusable TMs
- Running shoes / faster movement
- Physical/Special split
- Pokemon available from both versions
- Updated type chart (Dark, Steel, Fairy from later gens?)

---

## References

- [pokered Wiki](https://github.com/pret/pokered/wiki) - Tutorials for common modifications
- [RGBDS Documentation](https://rgbds.gbdev.io/docs/) - Assembler reference
- [pret Discord](https://discord.gg/pokemon-reverse-engineering) - Community help
